                    ...
                    .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelHintergrundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jLabelMagnesiumAnzeige))
                            .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jLabelStickstoffAnzeige))
                            .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jLabelPhosphorAnzeige))
                            .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jLabelKalziumAnzeige))
                            .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanelHintergrundLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jLabelKaliumAnzeige)))))
